        ...
        <div>
            <div className="container-fulid ">
                <div className="navbar d-flex justify-content-between">
                    ...
                    <ul className="nav justify-content-center align-items-center">
                        ...
                        <img className="image-body rounded-pill mt-2" src={profile} alt="profile" width={30} height={30} />

                        <NavDropdown className="navar-text text-center" title="admin" text="white">
                            <NavDropdown.Item href="#">Action</NavDropdown.Item>
                            <NavDropdown.Item href="#action/3.2">
                                My Profile
                            </NavDropdown.Item>
            ...
            {data.map((item) => (
                ...
                <div className="container-fluid bg-light mt-2 ">
                    <div className='mb-4 mt-5 text-capitalize'>
                        <h5 >Profile</h5>
